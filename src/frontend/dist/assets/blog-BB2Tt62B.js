import { c as createLucideIcon } from "./index-CMVflWSo.js";
/**
...
const BLOG_POSTS = [
  {
    ...
    category: "Trek Tips",
    excerpt: "Everything you need to know about India's most beloved winter snowscape — from base camp logistics to summit-day strategy, packing lists, and the best photo spots.",
  ...
  },
  {
    ...
    excerpt: "A comprehensive pilgrim's handbook for the four sacred dhams of Uttarakhand — Yamunotri, Gangotri, Kedarnath, and Badrinath — covering opening dates, route logistics, and spiritual significance.",
    heroImage: "https://images.unsplash.com/photo-1544132583786-2b82cca7f5d7?w=1200&q=80",
    author: {
      name: "Priya Sharma",
  ...
  },
  {
    ...
    category: "Gear",
    excerpt: "A practical, no-BS guide to building your first trekking kit without overspending — what to buy, what to skip, what to borrow, and the best brands available in India.",
  ...
  },
  {
    ...
    category: "Stories",
    excerpt: "I arrived at Sankri with a panic attack and left with a summited mountain and something I hadn't felt in years: peace. This is what happened in those seven days.",
  ...
  },
  {
    ...
    category: "Trek Tips",
    excerpt: "The Valley of Flowers blooms for only four months a year, and what you see depends entirely on when you visit. Our month-by-month breakdown tells you exactly which wildflowers peak when.",
