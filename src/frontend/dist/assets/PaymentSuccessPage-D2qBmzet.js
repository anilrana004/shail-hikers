import { a7 as useSearch, a3 as useAuthStatus, j as reactExports, t as jsxRuntimeExports, F as Layout, w as motion, L as Link, a8 as House, B as Mountain, U as Users } from "./index-CMVflWSo.js";
import { d as useBooking, e as useConfirmPayment } from "./useBookings-C-ACTtFC.js";
...
function PaymentSuccessPage() {
  ...
  reactExports.useEffect(() => {
    const pieces = Array.from({ length: 50 }, (_, i) => ({
      ...
      color: ["#1A1A1A", "#4A4A4A", "#F88379", "#D4A843", "#82C8E5"][Math.floor(Math.random() * 5)]
    }));
    setConfetti(pieces);
  }, []);
  reactExports.useEffect(() => {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-8", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body", style: { color: "#4A4A4A" }, children: "Confirming your booking..." })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body mb-2", style: { color: "#4A4A4A" }, children: "Your payment was successful, but we had trouble confirming it in our system." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 40, style: { color: "#2D6A4F" } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.h1,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Mountain, { size: 20, style: { color: "#F88379" } }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "span",
                            {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 16, style: { color: "#4A4A4A" } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 16, style: { color: "#4A4A4A" } }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
                            className: "font-body text-sm",
