import { j as reactExports, t as jsxRuntimeExports, L as Link, X, U as Users } from "./index-BbOSvcvx.js";
import { B as Button } from "./button-B-yHfRNz.js";
...
function PackagesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#E6D8C4" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base", style: { color: "#4A4A4A" }, children: "Handcrafted multi-trek bundles · Save up to 25% · Expert guides throughout" })
          ]
        }
      ),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 p-5 gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#4A4A4A" }, children: "Duration" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", style: { color: "#1A1A1A" }, children: pkg.duration })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: { background: "rgba(255,255,255,0.8)" },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#4A4A4A" }, children: "Group Size" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", style: { color: "#1A1A1A" }, children: [
                          pkg.groupSize,
                          " persons"
                        ] })
                      ]
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: { background: "rgba(255,255,255,0.8)" },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#4A4A4A" }, children: "Treks Included" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", style: { color: "#1A1A1A" }, children: pkg.treks.join(" + ") })
                      ]
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: pkg.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-xs", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#1A1A1A" }, children: h })
                ] }, h)) }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-2 space-y-1", children: pkg.includes.map((inc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4A4A4A" }, children: inc })
                      ]
                    },
                    inc
                  )) })
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mb-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#4A4A4A" }, children: "per person" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Link,
                        {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
                COMPARISON_FEATURES.map((feat, i) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    {
                      style: {
                        background: i % 2 === 0 ? "#E6D8C4" : "rgba(255,255,255,0.7)",
                        borderBottom: "1px solid rgba(232,160,170,0.07)"
                      },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3", style: { color: "#4A4A4A" }, children: feat.label }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { background: "#FFFFFF" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "td",
                    {
                      className: "px-5 py-4",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto px-4 md:px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-8", style: { color: "#4A4A4A" }, children: "The bigger your group, the more you save." }),
            ...
            discount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "#1A1A1A" }, children: [
                "Group of ",
                groupSize,
                " qualifies for a",
                " ",
              ...
              PACKAGES.map((pkg) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: { background: "rgba(255,255,255,0.8)" },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4A4A4A" }, children: pkg.name }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs pt-2", style: { color: "#4A4A4A" }, children: "Contact us for groups of 16+ for custom pricing." })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "#4A4A4A" }, children: [
                "Travelling with",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#1A1A1A" }, children: "5 or more?" }),
                " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 grid grid-cols-3 gap-3 text-xs text-center", children: [
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#4A4A4A" }, children: label })
                  ]
                },
                label
              )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-6", style: { color: "#4A4A4A" }, children: "Take our 2-minute Trek Finder quiz and we'll recommend the perfect package for you." }),
