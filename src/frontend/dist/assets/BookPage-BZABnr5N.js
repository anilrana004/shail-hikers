import { c as createLucideIcon, N as useParams, j as reactExports, t as jsxRuntimeExports, A as AnimatePresence, w as motion, V as User, W as Phone, Y as Mail, B as Mountain, D as MapPin, E as Shield } from "./index-CqRCuDMS.js";
import { T as TREKS } from "./treks-CFuBXqZV.js";
import { u as useBatchesByTrek, a as useCreateBooking } from "./useBookings-D32VhHZ1.js";
import { C as Calendar } from "./calendar-Dr446uwV.js";
import { P as Package, G as Gift } from "./package-CvEKsVBk.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-3 cursor-pointer", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "#E8A0AA" }, children: "I agree to the Terms & Conditions and Cancellation Policy" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-3 cursor-pointer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
        {
          ...
          style: {
            background: termsAccepted && !createBooking.isPending ? "#B5525E" : "rgba(181,82,94,0.3)",
            color: "#FAD4D8",
            boxShadow: termsAccepted && !createBooking.isPending ? "0 4px 20px rgba(181,82,94,0.4)" : "none",
