...
import { Z as Subscribable, _ as pendingThenable, $ as resolveEnabled, a0 as shallowEqualObjects, a1 as resolveStaleTime, a2 as noop, a3 as environmentManager, a4 as isValidTimeout, a5 as timeUntilStale, a6 as timeoutManager, a7 as focusManager, a8 as fetchState, a9 as replaceData, aa as notifyManager, j as reactExports, ab as shouldThrowError, ac as useQueryClient, ad as useInternetIdentity, ae as createActorWithConfig, af as Record, ag as Nat, ah as Text, ai as Variant, aj as Null, ak as Int, al as Principal, am as Vec, an as Opt, ao as Bool, ap as Service, aq as Func, ar as HttpAgent, as as Actor, x as useNavigate, t as jsxRuntimeExports } from "./index-CmnsDpTB.js";
...
Service({
  ...
  "createBooking": Func(
    [Text, Nat, Vec(TravelerInfo), Vec(AddOn), Nat],
    [BookingPublic],
    []
  ),
...
const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    "calculateGroupPrice": IDL.Func(
      [IDL.Text, IDL.Nat, IDL.Vec(AddOn2)],
      [IDL.Nat],
      ["query"]
    ),
    ...
    "createBooking": IDL.Func(
      [IDL.Text, IDL.Nat, IDL.Vec(TravelerInfo2), IDL.Vec(AddOn2), IDL.Nat],
      [BookingPublic2],
      []
    ),
...
class Backend {
  ...
  async calculateGroupPrice(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_BatchPublic_n27(_uploadFile, _downloadFile, value) {
  return from_candid_record_n28(_uploadFile, _downloadFile, value);
}
function from_candid_BatchStatus_n29(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n30(_uploadFile, _downloadFile, value);
}
function from_candid_BlogCategory_n38(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n39(_uploadFile, _downloadFile, value);
}
function from_candid_BlogPostPublic_n36(_uploadFile, _downloadFile, value) {
  return from_candid_record_n37(_uploadFile, _downloadFile, value);
}
function from_candid_BookingPublic_n2(_uploadFile, _downloadFile, value) {
  return from_candid_record_n3(_uploadFile, _downloadFile, value);
}
function from_candid_Difficulty_n24(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n25(_uploadFile, _downloadFile, value);
}
function from_candid_LoyaltyTier_n19(_uploadFile, _downloadFile, value) {
...
function from_candid_Trek_n22(_uploadFile, _downloadFile, value) {
  return from_candid_record_n23(_uploadFile, _downloadFile, value);
}
function from_candid_UserProfilePublic_n17(_uploadFile, _downloadFile, value) {
...
function to_candid_BlogCategory_n33(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n34(_uploadFile, _downloadFile, value);
}
function to_candid_Difficulty_n44(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n45(_uploadFile, _downloadFile, value);
}
function to_candid_MealPreference_n15(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n16(_uploadFile, _downloadFile, value);
}
function to_candid_NewsletterPreference_n49(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n50(_uploadFile, _downloadFile, value);
}
function to_candid_PaymentStatus_n51(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n52(_uploadFile, _downloadFile, value);
}
function to_candid_TravelerInfo_n13(_uploadFile, _downloadFile, value) {
...
function to_candid_vec_n12(_uploadFile, _downloadFile, value) {
