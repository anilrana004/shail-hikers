import { c as createLucideIcon, t as jsxRuntimeExports, F as Layout, w as motion, B as Mountain, U as Users, j as reactExports } from "./index-CMVflWSo.js";
import { E as Eye } from "./eye-CwUMDpzA.js";
import { H as Heart } from "./heart-D1MW-4rr.js";
import { T as Trash2 } from "./trash-2-HoP1ErL4.js";
...
function CounterItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-8 h-8 mx-auto mb-3", style: { color: "#F88379" } }),
...
function AboutPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { style: { background: "#FFFFFF" }, className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 30 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { style: { background: "#E6D8C4" }, className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: 20 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { style: { background: "#FFFFFF" }, className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: 20 },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              bottom: 0,
              width: 2,
              background: "linear-gradient(to bottom, #F88379, rgba(248,131,121,0.1))",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { style: { background: "#FFFFFF" }, className: "py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: 20 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: envCommitments.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "w-7 h-7", style: { color: "#2D6A4F" } }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { style: { background: "#E6D8C4" }, className: "py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0 },
