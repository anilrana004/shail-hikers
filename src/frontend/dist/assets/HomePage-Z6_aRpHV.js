import { c as createLucideIcon, f as frame, a as cancelFrame, i as interpolate, s as supportsViewTimeline, b as supportsScrollTimeline, p as progress, v as velocityPerSecond, d as isHTMLElement, e as defaultOffset$1, g as clamp, n as noop, r as resize, h as frameData, u as useConstant, j as reactExports, k as useIsomorphicLayoutEffect, m as microtask, l as cancelMicrotask, o as motionValue, M as MotionConfigContext, q as collectMotionValues, t as jsxRuntimeExports, A as AnimatePresence, w as motion, X, L as Link, x as useNavigate, S as Search, U as Users, C as Clock, y as ChevronDown, z as Send, B as Mountain, D as MapPin, I as Instagram, E as Shield } from "./index-CMVflWSo.js";
import { G as Gift, P as Package } from "./package-eGnJLO0s.js";
import { A as ArrowRight } from "./arrow-right-CziVngfG.js";
import { P as Play } from "./play-DKGHMM6_.js";
import { T as TREKS, B as BLOG_POSTS, D as DIFFICULTY_COLORS, a as TESTIMONIALS, Y as YATRAS } from "./treks-CGIURMuU.js";
import { C as Calendar } from "./calendar-B6uEOwgl.js";
import { T as TrendingUp } from "./trending-up-CVjmPcUA.js";
import { E as Eye } from "./eye-CwUMDpzA.js";
import { C as CircleCheckBig } from "./circle-check-big-1uC3XuWM.js";
import { H as Heart } from "./heart-D1MW-4rr.js";
import { R as ResponsiveContainer, A as AreaChart, a as Area } from "./AreaChart-mRyCCRcL.js";
import { u as useInView } from "./use-in-view-8AZ-OCAz.js";
import { C as Check } from "./check-Cu3DywVU.js";
import { S as Star } from "./star-BP2yrVNJ.js";
import { M as Map$1 } from "./map-CzOsffzm.js";
              ...
              !submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gift, { size: 28, style: { color: "#F88379" } })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mb-2", style: { color: "#4A4A4A" }, children: [
                  "Get",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-6", style: { color: "#4A4A4A70" }, children: "Join 8,000+ trekkers — exclusive offer for new subscribers only." }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "#4A4A4A" }, children: [
                  "Your ₹500 coupon is on its way to",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#D4A843" }, children: email }),
                  ".",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(180deg, rgba(255,255,255,0.4) 0%, rgba(255,255,255,0.15) 40%, rgba(255,255,255,0.85) 80%, rgba(26,14,16,1) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0",
            style: {
              background: "radial-gradient(ellipse at 30% 50%, rgba(248,131,121,0.12) 0%, transparent 60%)"
            }
          }
        ),
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            style: {
                              background: HERO_BADGES[activeBadge].urgent ? "#F88379" : "#2D6A4F",
                              animation: "pulse 1.5s ease-in-out infinite"
                            }
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "#4A4A4A" }, children: HERO_BADGES[activeBadge].text })
                      ]
                    }
                  )
                }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center", children: [
          ...
          QUICK_FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                background: activeFilters.includes(f) ? "#F88379" : "rgba(255,255,255,0.8)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto text-xs", style: { color: "#4A4A4A60" }, children: [
            "Showing ",
            results.length,
            " trek",
            results.length !== 1 ? "s" : ""
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] truncate", style: { color: "#4A4A4A" }, children: [
            "just booked ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#D4A843" }, children: p.trek }),
            " ✓"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px]", style: { color: "#4A4A4A66" }, children: p.time })
        ] })
      ]
    }
  ) });
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-7 gap-1", children: [
                  ...
                  Array.from({ length: days }, (_, d) => {
                    ...
                    const seatsColor = batch ? batch.seats <= 3 ? "#F88379" : batch.seats <= 7 ? "#D4A843" : "#2D6A4F" : null;
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap justify-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#4A4A4A" }, children: item.label })
        ] }, item.label)) })
      ] })
    }
  );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h2,
            {
              ...
              children: [
                "COMPARE TREKS",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F88379", fontStyle: "italic" }, children: "SIDE BY SIDE" })
              ]
            }
          )
        ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.h2,
              {
                ...
                children: [
                  "FORGE YOUR TEAM",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F88379", fontStyle: "italic" }, children: "IN THE HIMALAYAS" })
                ]
              }
            )
          ] }),
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        style: {
                          background: expanded === i ? "rgba(248,131,121,0.1)" : "rgba(255,255,255,0.7)"
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", style: { color: "#D4A843" }, children: "— HR Director, Infosys Hyderabad" })
                        ]
                      }
                    )
                  ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: !submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#4A4A4A" }, children: "Our corporate team will contact you within 4 hours with a custom proposal." })
                ] })
              }
            )
          ] })
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-8", children: DIFFICULTIES.map((diff, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.button,
          {
            ...
            style: {
              background: selected === i ? `${diff.color}20` : "rgba(255,255,255,0.8)",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#4A4A4A" }, children: diff.sublabel })
            ]
          },
          diff.level
        )) }),
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-6", children: DIFFICULTIES[selected].treks.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "#1A1A1A" }, children: t })
                ] }, t)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
...
function TrekCard({ trek, index }) {
  ...
  const seatsColor = (trek.seatsAvailable ?? 10) <= 3 ? "#F88379" : (trek.seatsAvailable ?? 10) <= 7 ? "#D4A843" : "#2D6A4F";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 30 },
      ...
      style: {
        ...
        height: "420px",
        border: "1px solid rgba(248,131,121,0.2)",
        boxShadow: hovered ? "0 24px 60px rgba(248,131,121,0.25)" : "0 4px 24px rgba(0,0,0,0.4)",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0",
              style: {
                background: "linear-gradient(180deg, rgba(26,14,16,0) 30%, rgba(255,255,255,0.85) 65%, rgba(26,14,16,0.97) 100%)"
              }
            }
          )
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-4", children: [
          ...
          trek.completedThisMonth && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] mb-2", style: { color: "#4A4A4A70" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px]", style: { color: "#4A4A4A" }, children: "Guide: Deepak" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "#4A4A4A" }, children: "Our community captures the Himalayas" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "absolute inset-0",
                    style: {
                      background: "linear-gradient(180deg, rgba(26,14,16,0) 60%, rgba(255,255,255,0.85) 100%)"
                    }
                  }
                ),
                [
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: {
                            background: activeTrek === pin.slug ? "#1A1A1A" : "#F88379",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 left-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#4A4A4A80" }, children: "Hover pins to explore routes" }) })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: TREKS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      background: activeTrek === t.slug ? "rgba(248,131,121,0.2)" : "transparent",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px]", style: { color: "#4A4A4A60" }, children: [
        ...
        !submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      background: prefs.includes(p.id) ? "#1A1A1A" : "transparent",
                      border: "1.5px solid rgba(250,212,216,0.6)"
                    },
                    children: prefs.includes(p.id) && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 10, style: { color: "#F88379" } })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 24, style: { color: "#1A1A1A" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold", style: { color: "#1A1A1A" }, children: "You're subscribed!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
          ...
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", style: { background: "#FFFFFF" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-4", style: { color: "#4A4A4A" }, children: pkg.subtitle }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
            ...
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 left-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px]", style: { color: "#4A4A4A" }, children: [
                    v.duration,
                    " · ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-8 justify-center", children: [
            ...
            TREK_FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  background: activeFilter === f ? "#F88379" : "rgba(255,255,255,0.8)",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#4A4A4A70" }, children: [
                        t.city,
                        " · ",
                        t.trek,
                        " · ",
...
const WeatherIcon = ({ type }) => {
  ...
  if (type === "sunny") return /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { ...props, style: { color: "#D4A843" } });
          ...
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px]", style: { color: "#4A4A4A80" }, children: [
                  camp.temp,
                  " · ",
                  camp.condition
                ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h2,
            {
              ...
              children: [
                "NOT JUST A TREK.",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F88379", fontStyle: "italic" }, children: "AN EXPERIENCE." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      background: isOpen ? "rgba(248,131,121,0.12)" : "rgba(255,255,255,0.7)"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { size: 18, style: { color: "#F88379" } })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#4A4A4A" }, children: feat.shortDesc })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ChevronDown,
                        {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm", style: { color: "#4A4A4A" }, children: "Experience the divine — Uttarakhand's most revered pilgrimages" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: YATRAS.map((yatra, i) => {
            ...
            const pilgrimageColor = PILGRIMAGE_COLORS[yatra.pilgrimage] ?? "#D4A843";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                initial: { opacity: 0, y: 30 },
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-52 overflow-hidden", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: "absolute inset-0",
                        style: {
                          background: "linear-gradient(180deg, rgba(26,14,16,0) 40%, rgba(255,255,255,0.95) 100%)"
                        }
                      }
                    ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", style: { background: "#FFFFFF" }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h3",
                      {
