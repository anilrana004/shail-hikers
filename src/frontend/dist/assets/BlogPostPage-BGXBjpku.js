import { c as createLucideIcon, N as useParams, j as reactExports, t as jsxRuntimeExports, F as Layout, L as Link, w as motion, C as Clock } from "./index-CqRCuDMS.js";
import { B as BLOG_POSTS, T as Tag, C as CATEGORY_COLORS } from "./blog-Inbdas8j.js";
  ...
  if (!post) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl", style: { color: "#FAD4D8" }, children: "Article Not Found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#E8A0AA" }, children: "This post doesn’t exist or may have been removed." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[50vh] md:h-[65vh] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(to bottom, rgba(26,14,16,0.2) 0%, rgba(26,14,16,0.85) 80%, #1A0E10 100%)"
          }
        }
      ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#E8A0AA88" }, children: post.author.role })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { size: 15, style: { color: "#B5525E" } }),
                ...
                Link,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#E8A0AA66" }, children: [
                        trek.durationDays,
                        " days · ",
                        trek.difficulty
                      ] }),
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", style: { color: "#FAD4D8" }, children: post.author.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-2", style: { color: "#B5525E" }, children: post.author.role }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-4", style: { color: "#E8A0AA88" }, children: "Get new trek guides and batch alerts in your inbox." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "email",
