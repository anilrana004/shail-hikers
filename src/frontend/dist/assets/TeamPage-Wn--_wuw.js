import { t as jsxRuntimeExports, F as Layout, w as motion, D as MapPin } from "./index-CmnsDpTB.js";
import { S as Star } from "./star-DUUEjHRt.js";
import { C as CircleCheckBig } from "./circle-check-big-Bt0XpBYt.js";
import { A as Award } from "./award-DDQ5sHMI.js";
const guides = [
  {
    name: "Deepak Rawat",
...
function TeamPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#2D1B1E", minHeight: "100vh" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { style: { background: "#B5525E" }, className: "py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-center", children: stats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
