import { c as createLucideIcon, j as reactExports, t as jsxRuntimeExports, F as Layout, w as motion, D as MapPin, B as Mountain, A as AnimatePresence, X } from "./index-BbOSvcvx.js";
...
import { C as ChevronLeft } from "./chevron-left-jESmjGUK.js";
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 13, style: { color: "#F88379" } }),
                      photo.location
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Mountain, { size: 13, style: { color: "#D4A843" } }),
                      photo.altitude
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(UserRound, { size: 13, style: { color: "#82C8E5" } }),
                      photo.photographer
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
...
function GalleryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#E6D8C4", minHeight: "100vh" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 md:px-6 pb-20", children: [
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", style: { color: "#4A4A4A" }, children: "January 2025" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
            ...
            "div",
            {
              ...
              children: FILTERS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    color: activeTab === tab && !showVideo ? "#1A1A1A" : "#4A4A4A",
                    background: activeTab === tab && !showVideo ? "rgba(248,131,121,0.2)" : "transparent",
                    borderBottom: activeTab === tab && !showVideo ? "2px solid #F88379" : "2px solid transparent"
                  },
                  children: tab
                },
                tab
        ...
        !showVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mb-6", style: { color: "#4A4A4A99" }, children: [
          "Showing ",
          filtered.length,
          " photo",
          filtered.length !== 1 ? "s" : "",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-0.5", style: { color: "#82C8E5" }, children: [
                          "📷 ",
                          photo.photographer
                        ] })
                      ]
            ...
            children: VIDEOS.map((video, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", style: { background: "#FFFFFF" }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-1", style: { color: "#4A4A4A" }, children: [
                      video.views,
                      " views"
                    ] })
                  ] })
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "#4A4A4A" }, children: "Moments captured by our community of Himalayan adventurers" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { size: 28, style: { color: "#F88379" } })
              ] }),
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#4A4A4A" }, children: photo.trek })
                      ] })
                    ]
                  },
                  photo.id
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 22, style: { color: "#F88379" } })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5", style: { color: "#4A4A4A" }, children: "Share your Himalayan moments" })
                      ] })
                    ]
                  }
                )
