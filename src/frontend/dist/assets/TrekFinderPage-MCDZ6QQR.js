import { j as reactExports, t as jsxRuntimeExports, w as motion, A as AnimatePresence } from "./index-CqRCuDMS.js";
import { T as TREKS } from "./treks-CFuBXqZV.js";
import { C as Check } from "./check-CWoaEEyk.js";
import { R as RefreshCw } from "./refresh-cw-BtETu9af.js";
import { S as Share2 } from "./share-2-DhzPHsCZ.js";
import { C as ChevronLeft } from "./chevron-left-C2XhSyNx.js";
...
function SliderInput({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl", style: { color: "#C9A84C" }, children: formatLabel(value) }) }),
...
function TrekFinderPage() {
  ...
  const QUESTIONS = [
    {
      ...
      content: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: FITNESS_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          style: {
            background: answers.fitness === opt.value ? "rgba(181,82,94,0.2)" : "rgba(26,14,16,0.8)",
            border: answers.fitness === opt.value ? "2px solid #B5525E" : "2px solid rgba(181,82,94,0.2)"
          },
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs mt-0.5", style: { color: "#E8A0AA" }, children: opt.desc })
            ] }),
      ...
      content: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 sm:grid-cols-4 gap-2", children: MONTHS.map((m) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: sel ? "rgba(181,82,94,0.2)" : "rgba(26,14,16,0.8)",
              border: sel ? "2px solid #B5525E" : "2px solid rgba(181,82,94,0.2)",
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#E8A0AA" }, children: g.desc })
            ]
          },
          g.value
        );
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#E8A0AA" }, children: o.desc }),
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "#E8A0AA" }, children: o.desc })
              ] }),
              sel && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 18, style: { color: "#B5525E" } })
            ]
          },
          o.value
        );
  ...
  if (step === 8) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen", style: { background: "#1A0E10" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#E8A0AA" }, children: "Based on your preferences, here are our top recommendations" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6", children: results.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              style: {
                ...
                border: i === 0 ? "2px solid #B5525E" : "1px solid rgba(181,82,94,0.25)"
              },
              children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: r.reasons.map((reason) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#E8A0AA" }, children: reason })
                        ]
                      },
                      reason
                    )) }),
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "pb-2 pr-4", style: { color: "#E8A0AA" }, children: "Metric" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 pr-4", style: { color: "#E8A0AA" }, children: row.label }),
                    results.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "td",
                      {
                        className: "py-2 pr-4",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen", style: { background: "#1A0E10" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 sm:px-6 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#E8A0AA" }, children: "Answer 8 quick questions and we'll match you with the best trek" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          q.hint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-6", style: { color: "#E8A0AA" }, children: q.hint }),
          q.content
        ]
      },
      step
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          style: {
            background: step === 0 ? "rgba(181,82,94,0.05)" : "rgba(181,82,94,0.15)",
