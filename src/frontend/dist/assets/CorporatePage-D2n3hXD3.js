import { c as createLucideIcon, j as reactExports, t as jsxRuntimeExports, F as Layout, w as motion, E as Shield, U as Users, A as AnimatePresence, y as ChevronDown } from "./index-CMVflWSo.js";
...
function CorporatePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#E6D8C4", minHeight: "100vh" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-4", style: { background: "#FFFFFF" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-4", style: { background: "#E6D8C4" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: 20 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: packages.map((pkg, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          style: {
            ...
            boxShadow: pkg.highlight ? "0 0 30px rgba(248,131,121,0.2)" : "none"
          },
          children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-4", style: { background: "#FFFFFF" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: 20 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: recommendation && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#D4A843" }, children: "Recommended: " }),
                  recommendation
                ]
              }
            ) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 px-4", style: { background: "#E6D8C4" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: 20 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", style: { background: "#FFFFFF" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", style: { background: "#E6D8C4" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#FFFFFF", padding: "2rem" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h3",
              {
                style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", style: { background: "#FFFFFF" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            ...
            insuranceOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-5 h-5", style: { color: "#F88379" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-5 h-5", style: { color: "#F88379" } })
          ]
        }
      ),
          ...
          submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#4A4A4A", fontFamily: "var(--font-body)" }, children: "Our corporate team will reach out within 4 hours with a customised proposal for your team." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
