import { c as createLucideIcon, j as reactExports, t as jsxRuntimeExports, R as React, H as reactDomExports, J as ReactDOM, X, L as Link } from "./index-CqRCuDMS.js";
import { u as useComposedRefs, c as composeRefs, a as cn, b as createSlot$1, B as Button } from "./button-DuVvz3JT.js";
...
function TrekCard({ trek }) {
  ...
  const diffColor = DIFFICULTY_COLORS[trek.difficulty] ?? "#B5525E";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-52 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: { background: "rgba(26,14,16,0.7)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Heart,
                {
                  size: 16,
                  fill: wishlisted ? "#B5525E" : "none",
                  stroke: wishlisted ? "#B5525E" : "#FAD4D8"
                }
              )
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 left-3 flex gap-1 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: { background: diffColor, color: "#FAD4D8" },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 p-4 gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs line-clamp-2", style: { color: "#E8A0AA" }, children: trek.shortDescription }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          trek.rating && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { color: "#C9A84C" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 12, fill: "#C9A84C" }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", style: { color: "#E8A0AA" }, children: [
                    "From",
                    " "
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function FilterPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-sm", style: { color: "#FAD4D8" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-2", style: { color: "#E8A0AA" }, children: "Difficulty" }),
      DIFFICULTIES.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: `diff-${d}`, style: { color: "#FAD4D8" }, children: d })
      ] }, d))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold mb-2", style: { color: "#E8A0AA" }, children: [
        "Max Duration: ",
        maxDuration,
        " days"
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-2", style: { color: "#E8A0AA" }, children: "Best Season" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: SEASONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: {
            borderColor: season === s ? "#B5525E" : "rgba(232,160,170,0.3)",
            background: season === s ? "#B5525E" : "transparent",
            color: "#FAD4D8"
          },
          children: s
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold mb-2", style: { color: "#E8A0AA" }, children: "Group Type" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: GROUP_TYPES.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: "text-xs px-2 py-1 rounded-full border transition-colors",
          style: {
            borderColor: groupType === g ? "#B5525E" : "rgba(232,160,170,0.3)",
            background: groupType === g ? "#B5525E" : "transparent",
            color: "#FAD4D8"
          },
          children: g
        },
...
function TreksPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#2D1B1E" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "py-16 px-6 text-center",
          style: {
            background: "linear-gradient(180deg, #1A0E10 0%, #2D1B1E 100%)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base", style: { color: "#E8A0AA" }, children: "14 legendary trails · handpicked routes · expert guides" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 min-w-max mx-auto max-w-6xl", children: QUICK_FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                borderColor: activeQuick.includes(f.key) ? "#B5525E" : "rgba(232,160,170,0.3)",
                background: activeQuick.includes(f.key) ? "#B5525E" : "transparent",
                color: "#FAD4D8"
              },
              children: f.label
            },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm", style: { color: "#E8A0AA" }, children: [
                "Showing",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#FAD4D8" }, children: filtered.length }),
                " ",
                "treks"
              ] })
            ] }),
          ...
          filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-5", style: { color: "#E8A0AA" }, children: "Try broadening your search criteria" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    onClick: clearAll,
